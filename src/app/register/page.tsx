    ...
    <div className="min-h-screen bg-white flex flex-col lg:flex-row overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-[#050608] items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 p-16 max-w-xl">
          ...
          >
            <div className="inline-flex p-3 bg-emerald-500/10 backdrop-blur-md rounded-2xl text-emerald-400 mb-8 border border-white/10 shadow-xl">
              <UserPlus size={32} />
            </div>
            <h2 className="text-6xl font-black text-white mb-6 tracking-tight leading-[1.1]">
              Join the <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-blue-400">Global Grid.</span>
            </h2>
            <p className="text-xl text-slate-400 font-medium leading-relaxed">
              Establish your digital operational identity. 
              Configure your credentials and assigned laboratory protocols.
            </p>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full border border-white/20 flex items-center justify-center text-white font-bold">01</div>
              <div className="text-[10px] font-black text-emerald-500 uppercase tracking-[0.3em]">Validate ID</div>
            </div>
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full border border-white/20 flex items-center justify-center text-white font-bold">02</div>
              <div className="text-[10px] font-black text-emerald-500 uppercase tracking-[0.3em]">Assign Role</div>
            </div>
          </motion.div>
        </div>
