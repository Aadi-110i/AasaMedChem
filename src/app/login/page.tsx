...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-blue-100 rounded-full blur-[120px] opacity-40 -translate-y-1/2 translate-x-1/2"></div>
      <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-indigo-100 rounded-full blur-[100px] opacity-30 translate-y-1/2 -translate-x-1/2"></div>
      ...
      <motion.div 
        ...
        className="w-full max-w-[460px] bg-white rounded-[40px] p-12 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.08)] border border-slate-100 relative z-10"
      >
        <div className="text-center mb-12">
          <div className="inline-flex p-4 bg-blue-50 text-blue-600 rounded-2xl mb-6 shadow-sm">
            <Fingerprint size={32} />
          </div>
          <h1 className="text-4xl font-black text-slate-900 mb-3 tracking-tight">Operator Login</h1>
          <p className="text-slate-500 font-medium leading-relaxed">Initialize secure synchronization protocol with the AasaMedChem grid.</p>
        </div>
        ...
        <form action={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-1">Identity Identifier</label>
            <input 
              type="email" 
              name="email" 
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-1">Secure Access Key</label>
        ...
        <div className="mt-12 pt-8 border-t border-slate-50 text-center">
          <p className="text-sm text-slate-400 font-bold uppercase tracking-tight">
            Unregistered Node? <Link href="/register" className="text-blue-600 hover:text-blue-700 underline underline-offset-4 ml-1">Request Credentials</Link>
          </p>
        </div>
      </motion.div>
    </div>
